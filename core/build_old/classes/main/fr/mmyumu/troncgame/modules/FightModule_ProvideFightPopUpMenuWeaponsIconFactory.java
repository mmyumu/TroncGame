...
public final class FightModule_ProvideFightPopUpMenuWeaponsIconFactory implements Factory<FightPopUpMenuIcon> {
  ...
  public FightModule_ProvideFightPopUpMenuWeaponsIconFactory(FightModule module, Provider<AssetManager> assetManagerProvider, Provider<I18NBundle> bundleProvider, Provider<FontManager> fontManagerProvider) {  
    assert module != null;
    this.module = module;
  ...
  public FightPopUpMenuIcon get() {  
    FightPopUpMenuIcon provided = module.provideFightPopUpMenuWeaponsIcon(assetManagerProvider.get(), bundleProvider.get(), fontManagerProvider.get());
    if (provided == null) {
  ...
  public static Factory<FightPopUpMenuIcon> create(FightModule module, Provider<AssetManager> assetManagerProvider, Provider<I18NBundle> bundleProvider, Provider<FontManager> fontManagerProvider) {  
    return new FightModule_ProvideFightPopUpMenuWeaponsIconFactory(module, assetManagerProvider, bundleProvider, fontManagerProvider);
  }
}
